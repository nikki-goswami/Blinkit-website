...
export default function SnackCard({item}) {
  return (
     <div className='shadow-md bg-white p-4 m-4'>
               <div className='flex justify-center items-center'> <img className='w-full h-full object-cover ' src={item.images[0]} alt="" /></div>
