    ...
    <div className='w-full bg-white'>
      <div className="max-w-7xl mx-auto p-4 ">
        <div className=' grid  sm:grid-cols-1 md:grid-cols-2 '>
          ...
          <ul className='list-none p-3'> <h2 className='text-2xl font-bold mb-4'>Useful Links</h2>
            <li><a href="#">Blog</a></li>
        ...
        <div className="grid  grid-cols-2  md:grid-cols-3 p-3 items-center">
          <ul className='p-3'> <span className='text-2xl font-bold  '>Categories</span> <span className='ml-2 text-[green]'>see all</span>
          <li className='mt-4'><a href="#">Vegetables & Fruits</a></li>
        ...
        <li><a href="#">Rakhi Gifts</a></li>
          ...
          <ul className='list-none mt-15 hidden md:block '>
        ...
        <div className="bg-[#fcfcfc] grid  md:grid-cols-3 p-3 gap-3 mb-10 sm:grid-cols-2 sm:justify-center">
          ...
          <div className='grid grid-cols-5 gap-1 hidden md:flex '>
          ...
          <img className='w-[40px] h-[40] rounded-2xl' src="https://blinkit.com/f01e50d66f4eddb1a1da.svg" alt="" />
